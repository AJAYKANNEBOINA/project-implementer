...
function Blogs() {
  return (
    <section id="blogs" className="bg-section-soft border-y border-border/60">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        <p className="text-xs font-semibold tracking-widest text-muted-foreground">FROM THE BLOG</p>
        <div className="mt-2 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground">Walk-in drive insights & tips.</h2>
          <p className="text-sm text-muted-foreground max-w-md">
